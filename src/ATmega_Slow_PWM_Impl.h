...
#ifndef ATmega_Slow_PWM_IMPL_H
#define ATmega_Slow_PWM_IMPL_H
...
void ATmega_TimerInterrupt::detachInterrupt()
{
  //cli();//stop interrupts
  noInterrupts();
...
void ATmega_TimerInterrupt::reattachInterrupt(const unsigned long& duration)
{
  //cli();//stop interrupts
  noInterrupts();
